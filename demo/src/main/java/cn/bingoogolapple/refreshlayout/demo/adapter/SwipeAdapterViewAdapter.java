...
public class SwipeAdapterViewAdapter extends BGAAdapterViewAdapter<RefreshModel> {
    ...
    protected void setItemChildListener(BGAViewHolderHelper viewHolderHelper) {
        ...
        //监听侧滑状态，保证只显示一个可用于编辑的侧滑item
        swipeItemLayout.setDelegate(new BGASwipeItemLayout.BGASwipeItemLayoutDelegate() {
            @Override
            public void onBGASwipeItemLayoutOpened(BGASwipeItemLayout swipeItemLayout) {
                Log.i("TAG","ItemLayoutOpened");
            ...
            public void onBGASwipeItemLayoutClosed(BGASwipeItemLayout swipeItemLayout) {
                Log.i("TAG","ItemLayoutClosed");
                mOpenedSil.remove(swipeItemLayout);
            }

            @Override
            public void onBGASwipeItemLayoutStartOpen(BGASwipeItemLayout swipeItemLayout) {
                Log.i("TAG","ItemLayoutStartOpen");
                closeOpenedSwipeItemLayoutWithAnim();
            }
        });
        ...
        viewHolderHelper.setItemChildClickListener(R.id.tv_item_swipe_edit);
    }
