...
public class RefreshRecyclerViewFragment extends BaseFragment implements BGARefreshLayout.BGARefreshLayoutDelegate, BGAOnRVItemClickListener, BGAOnRVItemLongClickListener, BGAOnItemChildClickListener, BGAOnItemChildLongClickListener {
    ...
    protected void processLogic(Bundle savedInstanceState) {
        ...
        textView1= (TextView) headerView.findViewById(R.id.tv_custom_header2_title);
        textView2= (TextView) headerView.findViewById(R.id.tv_custom_header2_desc);
        /****
         * 使用mRefreshLayout添加头部
       ...
       // mRefreshLayout.setCustomHeaderView(headerView, true);
        ...
        stickinessRefreshViewHolder.setSpringDistanceScale(0.8f);
    ...
    private void getResult(final int mNewPageNumber) {
                ...
                ThreadUtil.runInUIThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if(mNewPageNumber<=1){
                            ...
                            textView1.setText(R.string.test_custom_header_title);
                            textView1.setText(R.string.test_custom_header_desc);
                        }else{
